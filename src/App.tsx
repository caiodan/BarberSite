        ...
        <Modal
          ...
          footer={
            <Row style={{ display: 'flex', justifyContent: 'end', gap: 10 }}>
              ...
              <Button style={{ background: ' linear-gradient(rgb(185, 43, 49), rgb(145 28 33))', color: '#fff' }} onClick={handleCancelAgendamentoConfirm}>OK</Button>
            </Row>
    ...
    return (
      <Row style={{ display: 'flex', background: '#fbfbfb', justifyContent: 'center', alignItems: 'center', width: '100%', flexDirection: 'column', gap: 30 }}>
        <Row style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 15 }}>
          <h1 style={{ margin: 0, color: ' linear-gradient(rgb(185, 43, 49), rgb(145 28 33))' }}>SERVIÇOS</h1>
          ...
          {Cortes.map((el) => {
            return (
              <div onClick={() => setEtapa(2)} style={{ boxShadow: 'rgba(0, 0, 0, 0.15) 0px 5px 15px 0px', display: 'flex', flexDirection: 'column', gap: 10, width: '40%', padding: '10px 0px', alignItems: 'center', justifyContent: 'center', background: '#fff', borderRadius: 10 }}>
                ...
                <span style={{ fontWeight: '500', background: ' linear-gradient(rgb(185, 43, 49), rgb(145 28 33))', color: '#fff', padding: '2px 15px', borderRadius: '5px' }}>{el.Valor}</span>
              </div>
            )
          })}
        </Row>
        <Row style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <Button onClick={(() => { setEtapa(0) })} style={{ padding: '25px 15px', fontWeight: 'bold', width: '50%', fontSize: '4.5vw', background: ' linear-gradient(rgb(185, 43, 49), rgb(145 28 33))', border: 'none', scale: '0.9' }} type='primary'>Voltar</Button>
        </Row>
